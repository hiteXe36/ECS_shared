...
class RueckgabeWerkzeug
{
    ...
    private void nimmAusgewaehlteMedienZurueck()
    {
		...
		{
			JOptionPane.showMessageDialog(null, "Protokollieren fehlgeschlagen!\n"
					+ "Pruefe, ob die zu beschreibende Datei schreibgeschuetzt ist.","PROTOKOLLIER EXCEPTION", JOptionPane.ERROR_MESSAGE);
		}
    }
