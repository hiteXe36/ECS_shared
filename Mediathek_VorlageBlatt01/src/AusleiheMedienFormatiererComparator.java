 ...
 * @version SoSe 2017
 */
class AusleiheMedienFormatiererComparator implements Comparator<AusleiheMedienFormatierer>, Serializable
{
	 ...
	 */
	@Override
	public int compare(AusleiheMedienFormatierer mediumFormatierer1, AusleiheMedienFormatierer mediumFormatierer2)
	{
		int result = 0;
		if ((mediumFormatierer1 != null) && (mediumFormatierer2 != null))
		{
			...
			result = medium1.getMedienBezeichnung().compareTo(medium2.getMedienBezeichnung());
			if (result == 0)
			{
